    ...
    <section className="mb-8">
      ...
      {stats && (
        <>
          ...
          <div className="mt-6">
            <p className="text-sm font-medium text-gray-700 mb-2">Avis / jour (7j)</p>
...
export default function AdminPage() {
  // 👉 les hooks doivent être AU DÉBUT du composant (pas dans le return)
