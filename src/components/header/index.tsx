...
export default function Header() {
  return (
    <header className="relative w-full h-[300px] md:h-[340px] bg-[#f7eaf2] flex flex-col items-center justify-center shadow-[0_8px_24px_rgba(181,125,105,0.08)]">
      {/* Actions top-right */}
      <div className="absolute right-5 top-4 flex items-center gap-3 md:gap-4">
        {/* Favoris (cœur) */}
        <Link
          href="/favorites"
          aria-label="Favoris"
        ...
        <Link
          href="/login"
          className="rounded-full px-3.5 py-1.5 text-sm font-medium text-[#6b4a3f] bg-white/80 ring-1 ring-[#e7c7b6] shadow-[0_2px_8px_rgba(181,125,105,0.12)] hover:bg-white transition"
        >
          Se connecter
        </Link>
        <Link
          href="/signup"
          className="rounded-full px-3.5 py-1.5 text-sm font-medium text-white bg-[#b57d69] shadow-[0_6px_18px_rgba(181,125,105,0.25)] hover:brightness-105 transition"
        >
          Créer un compte
        </Link>
      </div>
